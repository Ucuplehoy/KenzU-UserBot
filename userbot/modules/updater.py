    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari 💥KENZU-UBOT💥.`'
            )
            repo.__del__()
            return
...
async def upstream(event):
    ...
    if changelog == '' and force_update is False:
        await event.edit(
            f'\n💥𝘒𝘦𝘯𝘻𝘜-𝘜𝘴𝘦𝘳𝘉𝘰𝘵💥\n\n𝚈𝚘𝚞 𝚊𝚛𝚎 𝚊𝚕𝚛𝚎𝚊𝚍𝚢 𝚞𝚜𝚒𝚗𝚐 𝚝𝚑𝚎 𝚕𝚊𝚝𝚎𝚜𝚝 𝚟𝚎𝚛𝚜𝚒𝚘𝚗 \n')
        await asyncio.sleep(15)
        await event.delete()
        return repo.__del__()

    if conf is None and force_update is False:
        changelog_str = f'**Pembaruan Untuk 💥KENZU-UBOT💥 :\n\n⚒️ Pembaruan Data :**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('` Proses Update 💥KENZU-UBOT💥, Loading....1%`')
        await event.edit('` Proses Update 💥KENZU-UBOT💥, Loading....20%`')
        await event.edit('` Proses Update 💥KENZU-UBOT💥, Loading....35%`')
        await event.edit('` Proses Update 💥KENZU-UBOT💥, Loading....77%`')
        await event.edit('` Proses Update 💥KENZU-UBOT💥, Updating...90%`')
        await event.edit('` Proses Update 💥KENZU-UBOT💥, Mohon Tunggu Sebentar....100%`')
